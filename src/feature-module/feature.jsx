...
const Feature = () => {
  ...
  const miniSidebar = useSelector((state) => state.sidebarSlice.miniSidebar);
  const expandMenu = useSelector((state) => state.sidebarSlice.expandMenu);
  ...
  return (
    <div
      className={`
       ...
       ${
         dataSidebar === "darkblack_data_sidebar"
